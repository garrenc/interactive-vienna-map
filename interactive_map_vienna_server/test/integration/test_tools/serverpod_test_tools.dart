...
class TestEndpoints {
  ...
  late final _WaterStationEndpoint waterStation;
...
class _InternalTestEndpoints extends TestEndpoints
  ...
  void initialize(
    ...
    toilet = _ToiletEndpoint(
      endpoints,
      serializationManager,
    );
    waterStation = _WaterStationEndpoint(
      endpoints,
      serializationManager,
    );
...
class _ToiletEndpoint {
  ...
  _i3.Future<void> uploadToilets(_i1.TestSessionBuilder sessionBuilder) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
        endpoint: 'toilet',
        method: 'uploadToilets',
      );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'toilet',
          methodName: 'uploadToilets',
          parameters: _i1.testObjectToJson({}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue = await (_localCallContext.method.call(
...
class _WaterStationEndpoint {
  ...
  _i3.Future<void> uploadWaterStations(
      _i1.TestSessionBuilder sessionBuilder) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
        endpoint: 'waterStation',
        method: 'uploadWaterStations',
      );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'waterStation',
          methodName: 'uploadWaterStations',
          parameters: _i1.testObjectToJson({}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue = await (_localCallContext.method.call(
  ...
  _i3.Future<List<_i5.WaterStation>> getWaterStations(
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
        endpoint: 'waterStation',
        method: 'getWaterStations',
      );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'waterStation',
          methodName: 'getWaterStations',
          parameters: _i1.testObjectToJson({}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue = await (_localCallContext.method.call(
